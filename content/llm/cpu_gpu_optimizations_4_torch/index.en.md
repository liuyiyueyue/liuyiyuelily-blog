...
{{< figure src="./images/3_synchronize_trace.png" caption="Figure 3: CPU waits for GPU completion after synchronization. <br>Source code: [3_synchronize.py](./code/3_synchronize.py)" align="center" >}}
...
{{< figure src="./images/4_implicit_sync.png" caption="Figure 4: Implicit synchronization in a data-dependent GPU operation. <br>Source code: [4_implicit_synchronize.py](./code/4_implicit_synchronize.py)" align="center" >}}
...
{{< figure src="./images/5_no_double_buffer_trace.png" caption="Figure 5.1: No overlap. <br>Source code: [5_no_double_buffer.py](./code/5_no_double_buffer.py)" align="center" >}}
...
{{< figure src="./images/5_double_buffer_trace.png" caption="Figure 5.2: Data-compute overlap with double buffering. <br>Source code: [5_double_buffer.py](./code/5_double_buffer.py)" align="center" >}}
